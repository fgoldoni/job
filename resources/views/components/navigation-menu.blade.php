            ...
            <div class="hidden sm:ml-6 sm:flex sm:items-center">
                ...
                @else
                    <div class="flex-shrink-0">
                        <button type="button" class="relative inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-{{ config('setting.color') }}-600 shadow-lg hover:bg-{{ config('setting.color') }}-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-{{ config('setting.color') }}-500">
